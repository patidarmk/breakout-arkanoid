    ...
    <div className="min-h-[72vh] flex flex-col items-center justify-center">
      <div className="w-full max-w-4xl text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
          <Link to="/play" className="inline-flex items-center justify-center px-6 py-3 rounded-md bg-indigo-600 text-white font-medium shadow hover:bg-indigo-700">
            Play Now
          </Link>
          <Link to="/levels" className="inline-flex items-center justify-center px-6 py-3 rounded-md bg-white border border-gray-200 text-gray-700 hover:bg-gray-50">
            Browse Levels
          </Link>
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div className="text-left">
            ...
            <div className="mt-6">
              <Link to={`/levels/${featured.id}`} className="text-indigo-600 hover:underline">View level details →</Link>
            </div>
          </div>
        </div>
      </div>
